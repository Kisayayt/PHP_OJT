...
@section('content')
    <div class="container mt-5 mb-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                @if ($department->users->isEmpty())
                    <p class="text-muted"><i class="bi bi-emoji-frown"></i> Chưa có người nào trong phòng ban này.</p>
                @else
                    <ul class="list-group">
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h5 style="font-weight: bold" class="mb-0"><i class="bi bi-door-open"></i> Danh sách phòng ban con</h5>
            </div>
            <div class="card-body">
