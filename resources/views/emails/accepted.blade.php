...
<body>
    ...
    <div class="content">
        ...
        <h2>Lý do của bạn đã được admin chấp nhận!</h2>
        <p>Xin chào {{ $name }},</p>
        <p>Đơn giải trình của bạn hiện tại đã được chấp thuận!</p>
        <p style="color: red; font-weight: bold; font-style: italic">Lưu ý: Tuy được chấp nhận nhưng lương của bạn cũng
            sẽ trừ đi 10%</p>
