...
<body>
    ...
    <div class="content">
        ...
        <h2>Thông báo nhân viên hãy chấm công!</h2>
        <p>Xin chào các nhân viên!,</p>
        <p>Xin vui lòng các nhân viên hãy chấm công đúng giờ quy định</p>
        <p style="color: red; font-weight: bold; font-style: italic">Lưu ý: nếu không chấm công đúng giờ sẽ không được
            lương, hoặc gửi đơn mà được chấp thuận cũng sẽ bị trừ 10%</p>
        <div class="footer">
