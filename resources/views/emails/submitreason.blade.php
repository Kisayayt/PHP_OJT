...
<body>
    ...
    <div class="content">
        ...
        <h2>Đơn của bạn đã được nộp thành công!</h2>
        <p>Xin chào {{ auth()->user()->name }},</p>
        <p>Đơn của bạn đã nộp thành công, vui lòng chờ phản hồi từ phía admin!</p>
        <p><strong>Lý do giải trình của bạn là:</strong> {{ $reason }}</p>
